...
- 이들은 모두 할인율과 주문수량에 따른 주문금액의 상관계수는 낮았습니다. 고객들의 추가 구매를 유도하기 위해서는 식당과 관련된 물품들을 추천 혹은 제안하는 방안이 적합하다고 판단됩니다. 비록 할인 여부에 따른 주문 금액 차이는 없지만 할인이 제공되었을 때의 주문 금액은 조금이나마 증가하기 때문에 이를 이용한 방안이 필요하다고 생각합니다.
  - 추가 구매를 유도하는 방안
